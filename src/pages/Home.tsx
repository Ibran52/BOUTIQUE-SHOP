      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-6xl font-heading font-bold mb-6">Featured Collections</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <Link key={cat.name} to={cat.link} className="group relative h-[500px] rounded-3xl overflow-hidden shadow-lg">
                <img
                  src={cat.image}
                  alt={cat.name}
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-8">
                  <h3 className="text-3xl font-heading text-white font-bold mb-4">{cat.name}</h3>
